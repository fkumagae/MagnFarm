    ...
    <header>
      <div class="topo-barra">
        <div class="title-area">
          <img src="img/logo_bola.png" alt="Logo Magalface" class="logo-site" style="cursor:pointer" onclick="document.getElementById('form-contato')?.scrollIntoView({behavior: 'smooth'})" />
          <div class="title-and-name">
            <h1><a href="index.php?action=home" class="site-title" title="Voltar para a página inicial" style="color:#fff !important; text-decoration:none !important;">Magalface</a></h1>
            <?php if (is_logged_in()):
              $user = current_user();
        ...
        <div class="top-right-auth">
          ...
          <?php else: ?>
            <div class="auth-links"><a href="login.php">Entrar</a> | <a href="register.php">Registrar</a></div>
          <?php endif; ?>
...
if (is_logged_in()) {
  ...
  $authHtml .= '<li class="nav-auth"><a href="login.php">Entrar</a> | <a href="register.php">Registrar</a></li>';
}
?>

      <nav class="nav-fina">
        <ul id="site-menu">
          <li><a href="?action=projeto">Projeto</a></li>
          <li><a href="?action=planejamento">Planejamento</a></li>
          <li><a href="?action=fluxograma">Fluxograma</a></li>
          <li><a href="?action=esquemas">Esquemas eletrônicos</a></li>
          <li><a href="?action=dispositivos">Dispositivos</a></li>
